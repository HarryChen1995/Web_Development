...
<div class="Enroll">
    ...
    <b>Email</b><input class="enrollinput2" type="text" name="professor_email" required><br><br>
    <b>Password</b><input class="enrollinput3" type="password" name="professor_password" required><br><br>
